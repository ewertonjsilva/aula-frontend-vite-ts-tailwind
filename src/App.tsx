    ...
    <div className="min-h-screen bg-slate-50 text-slate-950 font-sans">
      <header className="border-b border-slate-200 bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          <SectionHeader
            title="Mockup SPA vs Página Tradicional"
            subtitle="Exemplo mobile-first que destaca a diferença entre navegação interna sem recarga e carregamento completo de página."
            label="Protótipo UX"
          />
            ...
            <div className="rounded-[2rem] border border-slate-200/90 bg-white p-6 shadow-sm shadow-slate-900/5">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
                ...
                <li className="flex gap-3">
                  ...
                  Simples, limpo e consistente para destacar exatamente a diferença entre abordagens.
                </li>
              </ul>
            </div>
          </section>
